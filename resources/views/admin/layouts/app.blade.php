        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.main-view') }}" class="nav-link {{ request()->is('admin/mail/') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ request()->is('admin/user*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.user.all-users') }}" class="nav-link">
                                    <i class="fas fa-user-alt nav-icon"></i>
                                    <p>Все заказы</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.user.all-users') }}" class="nav-link {{ request()->is('admin/shop*') ? 'active' : '' }}">
                            <i class="fas fa-user-alt nav-icon"></i>
                            <p>Магазины</p>
                        </a>
                    </li>
